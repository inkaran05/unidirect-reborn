    ...
    <header className="bg-white/90 backdrop-blur-lg shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        <Link to="/" className="flex items-center space-x-3" onClick={closeMenu}>
          {/* SVG Logo */}
          <svg className="h-8 w-8 text-brand-blue" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2.25L2 7.5L12 12.75L22 7.5L12 2.25Z"/>
            <path d="M2 16.5L12 21.75L22 16.5V11.25L12 16.5L2 11.25V16.5Z" fillOpacity="0.5"/>
            <path d="M20 12.375V8.25L12 12.75L4 8.25V12.375L12 17.25L20 12.375Z"/>
          </svg>
        ...
        <div className="hidden lg:flex items-center space-x-4">
          {user ? (
            <>
              ...
              <button onClick={handleLogout} className="bg-red-500 text-white font-bold py-2 px-6 rounded-lg hover:bg-red-600 transition-all">Logout</button>
            </>
          ) : (
            <Link to="/login" className="bg-brand-blue text-white font-bold py-2 px-6 rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105">Login</Link>
          )}
        </div>
